$(document).ready(function() {
	...
	if($(".slider").hasClass("slider-1")) {
		...
		slide = 1; 
		$progressBar.css('background-size', `40% 100%`).attr('aria-valuenow', 40);
	} else if ($(".slider").hasClass("slider-3")) {
		slide = 2; 
		$progressBar.css('background-size', `60% 100%`).attr('aria-valuenow', 60);
	} else if ($(".slider").hasClass("slider-4")) {
		slide = 3; 
		$progressBar.css('background-size', `80% 100%`).attr('aria-valuenow', 80);
